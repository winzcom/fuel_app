                    ...
                    <section class="content">
                        <section class="content invoice">
                            ...
                            <div class="row no-print">
                                <div class="col-xs-12">
                                    <a href="{{ route('seller-sell-show',Auth::user()->id ) }}" class="btn btn-success"><i class="fa fa-eye"></i> View Invoice</a>
                                    <button onclick="window.print();" style="margin-right: 5px;"
                                            class="btn btn-primary "><i class="fa fa-print"></i> Print
                                    </button>
                                    <a href="{{ route('seller-machine',Auth::user()->id ) }}" class="btn btn-danger"><i class="fa fa-shopping-cart"></i> New Sell</a>
                                </div>
                            </div>
                        </section>
                    </section>
